		  ...
		  <div class="login">
		    ...
		    {{ Form::open(array('url' => 'login')) }}
				...
				<p style="margin-top:0px;">
					{{ Form::password('password', array('placeholder' => 'Password Lama')) }}
				</p>

				<p style="margin-top:0px;">
					{{ Form::password('newpassword', array('placeholder' => 'Password Baru')) }}
				</p>

				<p style="margin-top:0px;">
					{{ Form::password('newpassword1', array('placeholder' => 'Konfirmasi Password Baru')) }}
				</p>
